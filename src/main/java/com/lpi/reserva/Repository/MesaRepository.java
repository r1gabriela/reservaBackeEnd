...
public interface MesaRepository extends CrudRepository<Mesa, Integer> {
	...
	public List<Mesa> verDisponibilidadeMesa(@Param("horaEntrada") Time horaEntrada, @Param("horaSaida") Time horaSaida,
			@Param("capacidade") Integer capacidade, @Param("dataReserva") Date dataReserva);
